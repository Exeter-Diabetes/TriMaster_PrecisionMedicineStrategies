...
Figure_data_full <- subset_3treatments_wuncalmodelC[, c("concordant_tx", "treatment_class", "hba1c_diff")]

model_FigureA    <- lmer(hba1c_diff ~ treatment_class * concordant_tx + prehba1c + period + (1 | study_id), data = subset_3treatments_wuncalmodelC)
...
Cairo(file = paste0(plot_path,"/model_SAresults_adjusted_uncalibrated.png" ), 
      type = "png",
      units = "in", 
      width = 18,
      height = 8, 
